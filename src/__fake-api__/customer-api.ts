...
class CustomerApi {
  ...
  getCustomerEmails(request?: GetCustomerEmailsRequest): GetCustomerEmailsResponse {
  ...
  getCustomerInvoices(request?: GetCustomerInvoicesRequest): GetCustomerInvoicesResponse {
